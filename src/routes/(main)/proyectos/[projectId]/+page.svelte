...
<section class="w-full py-12 lg:py-16" aria-labelledby="case-study-summary-heading">
	<div class="container mx-auto px-4">
		...
		<nav class="mt-6 flex flex-wrap gap-3" aria-label="Navegación de cierre">
			<a href={resolve('/(main)/proyectos')} class="btn">Ver más casos</a>
			<a href={resolve('/(main)/precios')} class="btn">Ver precios</a>
			<a href={resolve('/(main)/ivan-yarupaitan-rivera')} class="btn">Sobre el autor</a>
		</nav>
	</div>
</section>
