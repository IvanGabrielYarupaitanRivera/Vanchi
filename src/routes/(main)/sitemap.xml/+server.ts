...
export async function GET() {
	...
	const staticEntries: { path: string; priority: string; changefreq: string }[] = [
		...
		{ path: 'servicios/agentes-ia', priority: '0.8', changefreq: 'weekly' },
		{ path: 'servicios/automatizacion', priority: '0.8', changefreq: 'weekly' },
		{ path: 'servicios/consultoria', priority: '0.8', changefreq: 'weekly' },
