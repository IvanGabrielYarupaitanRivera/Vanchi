...
<section class="w-full py-40 vanchi-hairline border-t">
	<div class="max-w-5xl mx-auto px-4">
		<div class="flex items-center gap-2.5 mb-16">
			...
			<span class="vanchi-eyebrow">04 // AUTOR</span>
		</div>
			...
			<div class="lg:col-span-7">
				<div class="flex flex-col gap-6">
					<div class="card bg-base-200 border border-base-300 p-6 lg:p-8">
						<span class="mb-3 block font-mono text-xs font-medium tracking-[0.15em] text-secondary">FILOSOFÍA</span>
						<p class="font-mono text-sm leading-relaxed text-base-content/80">
							El software no debería necesitarte para funcionar. Cada agente que construyo
							recibe un objetivo, razona, usa herramientas y reporta resultados. Sin que
