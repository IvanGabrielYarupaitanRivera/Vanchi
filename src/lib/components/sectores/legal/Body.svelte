<script lang="ts">
	...
	let { projects }: { projects: readonly LegalProject[] } = $props();
</script>
		...
		<div class="grid gap-16 lg:grid-cols-12 lg:gap-24">
			<div class="lg:col-span-5">
				<h2 class="mb-8 vanchi-display text-3xl font-normal lg:text-5xl">
					Miles de folios,<br />
					<span class="italic">cero</span> indexación
				</h2>
				<p class="font-mono text-sm leading-relaxed text-base-content/60">
					Tus abogados saben de leyes. Pero pasan más tiempo buscando papeles que construyendo
					estrategia. El software tradicional te da un repositorio. Un agente te da <span
						class="text-base-content/80">un asistente que lee por vos</span
					>.
				</p>
			</div>
				...
				<div class="flex flex-col gap-6">
					<div class="card border border-base-300 bg-base-200 p-6 lg:p-8">
						...
						<p class="font-mono text-sm leading-relaxed text-base-content/80">
							<span class="text-base-content">Búsqueda manual de información.</span> Encontrar un dato
							específico entre miles de folios digitales y físicos consume horas que tus abogados no
							tienen.
						</p>
					</div>
					<div class="card border border-base-300 bg-base-200 p-6 lg:p-8">
						...
						>
						<p class="font-mono text-sm leading-relaxed text-base-content/80">
							<span class="text-base-content">Plazos que vencen sin alerta.</span> Sin un sistema que
							monitoree automáticamente cada fecha límite, un plazo procesal vencido es un caso perdido.
						</p>
					</div>
					<div class="card border border-base-300 bg-base-200 p-6 lg:p-8">
						<span class="mb-3 block font-mono text-xs font-medium tracking-[0.15em] text-secondary"
						...
						>
						<p class="font-mono text-sm leading-relaxed text-base-content/80">
							<span class="text-base-content">Notificaciones desconectadas.</span> Los responsables de
							cada informe no reciben alertas a tiempo. El seguimiento depende de que alguien recuerde
							revisar el sistema.
						</p>
					</div>
				</div>
		...
		<div class="grid gap-16 lg:grid-cols-12 lg:gap-24">
			<div class="lg:col-span-5">
				<h2 class="vanchi-display text-3xl font-normal lg:text-5xl">
					Un agente que<br />
					<span class="italic">no duerme</span>
				</h2>
				<p class="mt-8 font-mono text-sm leading-relaxed text-base-content/60">
					Indexa expedientes automáticamente. Notifica vencimientos por WhatsApp y email. Genera
					PDFs de seguimiento sin intervención humana. El agente trabaja en background mientras tus
					abogados se concentran en lo que importa: la estrategia legal.
				</p>
			</div>
			...
			<div class="lg:col-span-7">
				...
				<div class="mt-8 flex flex-wrap items-center gap-6">
					<a
						href="https://api.whatsapp.com/send/?phone=51985942670&text=Hola%20Ivan,%20quiero%20automatizar%20la%20gestion%20de%20expedientes%20de%20mi%20estudio."
						target="_blank"
