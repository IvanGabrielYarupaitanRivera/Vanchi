...
>
	...
	<div class="absolute bottom-0 left-0 z-20 flex w-full flex-col p-8">
		...
		<h3 class="mb-4 flex items-center justify-between gap-4">
			...
			<time class="mt-1 badge shrink-0 badge-outline badge-sm text-base-content/70">
				{project.date}
			</time>
		</h3>

		<p class="line-clamp-4 text-sm leading-relaxed text-base-content/70 lg:text-base">
			{project.description}
		</p>
