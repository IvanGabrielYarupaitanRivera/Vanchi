		...
		<div class="grid gap-16 lg:grid-cols-3 lg:gap-24">
			...
			<div class="flex flex-col gap-px lg:col-span-2">
				...
				<a
					...
					class="group card border border-base-300 bg-base-200 p-8 transition-all duration-100 hover:-translate-y-0.5 hover:border-base-content"
				>
					<div class="flex items-start justify-between gap-6">
						<div>
							...
							<p class="max-w-xs font-mono text-xs leading-relaxed text-base-content/60">
								Repositorios públicos, agentes autónomos, herramientas de código abierto.
							</p>
						</div>

						<svg
							class="mt-1 h-6 w-6 shrink-0 text-base-content/30 transition-colors duration-100 group-hover:text-base-content/60"
							fill="currentColor"
							viewBox="0 0 24 24"
							aria-hidden="true"
						>
				...
				>
					<div class="flex items-start justify-between gap-6">
						<div>
							...
							<p class="max-w-xs font-mono text-xs leading-relaxed text-base-content/60">
								Verificación de trayectoria profesional, red técnica y entidad jurídica.
							</p>
						</div>
